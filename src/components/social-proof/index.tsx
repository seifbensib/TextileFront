...
const socialProofs = [
  {
    ...
    company: `Tunisian Textile Co`,
    image: `/images/social-1.webp`,
    text: `Our collaboration has significantly transformed our production capabilities.
     The innovative solutions provided have streamlined our processes and enhanced product quality`,
  },
  {
    name: `Salem Benhmida `,
    company: `TNT, Inc.`,
    image: `/images/social-2.webp`,
    text: `has shared their positive experience with our innovative textile solutions. His insights emphasize the transformative impact on their production processes, 
    highlighting improved efficiency and product quality..`,
  },
];
